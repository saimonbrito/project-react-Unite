...
export function AttendeeList(){
  return(
    <div className=' flex flex-col gap-4'>
      ...
      <input  className="bg-transparent flex-1 outline-none border-0 p-0 text-sm" placeholder="Buscar participantes" type="text" />
      </div>
    </div>
            ...
            {Array.from({length:8}).map((_, i)=>{
              return(
                <tr key={i} className='border border-white/10  hover:bg-white/5'>
                  ...
                  <td className='py-3 px-4 text-sm text-zinc-300'>15896</td>
                  <td className='py-3 px-4 text-sm text-zinc-300'>
                    <div className='flex flex-col gap-1'>
                      <span className='font-semibold text-white'>Saimon Brito fernandes</span>
                      <span>saimon@mkteck.com.br</span>
                    </div>
                  </td>
                  <td className='py-3 px-4 text-sm text-zinc-300'>7 dias atraz</td>
                  <td className='py-3 px-4 text-sm text-zinc-300'>3 dias atraz</td>
                  <td className='py-3 px-4 text-sm text-zinc-300'>
